...
interface WindowManager {
    open: <T extends DialogData>(config: DialogSpec<T>, params?: any) => DialogInstanceApi<T>;
...
interface WindowManagerImpl {
    open: <T extends DialogData>(config: DialogSpec<T>, params: any, closeWindow: (dialog: DialogInstanceApi<T>) => void) => DialogInstanceApi<T>;
